...
export const InsightCards: React.FC<InsightCardsProps> = ({ summary }) => {
  ...
  // Helper to keep texts punchy and readable
  const trimText = (txt: string, maxLen = 75) => {
    if (!txt) return '';
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-5">
      {/* 1. KEY IDEA - Purple */}
      <div className="p-3.5 rounded-2xl bg-purple-50/70 dark:bg-purple-950/20 border border-purple-100 dark:border-purple-900/40 flex flex-col justify-between">
      ...
      <div className="p-3.5 rounded-2xl bg-emerald-50/70 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/40 flex flex-col justify-between">
        <div className="flex items-center gap-1.5 mb-2">
        ...
        <p className="text-xs font-medium text-neutral-800 dark:text-neutral-200 leading-snug">
          {trimText(recommendation)}
        </p>
      </div>

      {/* 3. IMPORTANT - Amber/Warm */}
      <div className="p-3.5 rounded-2xl bg-amber-50/70 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/40 flex flex-col justify-between">
        <div className="flex items-center gap-1.5 mb-2">
      ...
      {/* 4. FACT - Blue */}
      <div className="p-3.5 rounded-2xl bg-blue-50/70 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/40 flex flex-col justify-between">
        <div className="flex items-center gap-1.5 mb-2">
