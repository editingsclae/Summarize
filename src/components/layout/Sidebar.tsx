...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-full h-full bg-[#0D1321] text-white flex flex-col justify-between select-none border-r border-neutral-800/80 shrink-0">
      <div className="flex-1 overflow-y-auto px-4 py-5 space-y-6 no-scrollbar">
        ...
        <div className="px-2 flex items-center justify-between">
          <div>
            ...
            <p className="text-[11px] text-neutral-400 mt-1 font-medium tracking-normal pl-0.5">
          ...
          {onCloseMobile && (
            <button
              ...
              className="lg:hidden p-2 rounded-xl text-neutral-400 hover:text-white hover:bg-neutral-800 transition-colors cursor-pointer"
        ...
        {/* Upgrade to Pro Card */}
        <div className="p-4 rounded-3xl bg-gradient-to-br from-indigo-950/70 via-neutral-900 to-purple-950/50 border border-indigo-500/30 shadow-lg shadow-indigo-950/30 text-left">
          ...
          <ul className="space-y-1.5 text-[11px] text-neutral-300 mb-3.5">
          ...
          <button
            ...
            className="w-full py-2 px-3 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-bold text-xs flex items-center justify-center gap-1.5 shadow-md shadow-indigo-600/20 transition-all cursor-pointer active:scale-98"
          >
      ...
      <div className="p-3 border-t border-neutral-800/80 bg-[#090D17]">
        <button
          type="button"
