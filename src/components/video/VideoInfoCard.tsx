        ...
        <div className="flex-1 min-w-0 flex flex-col justify-between self-stretch">
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2.5 text-xs text-neutral-500 dark:text-neutral-400">
              ...
              <span>•</span>
              <span className={isOngoingLive ? 'font-semibold text-red-600 dark:text-red-400' : ''}>{viewsDisplay}</span>
            </div>
            ...
            <div className="mt-5 flex flex-wrap items-center gap-2.5">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 active:scale-98 text-white font-medium text-xs sm:text-sm shadow-sm transition-all"
              >
              ...
              <button
                ...
                onClick={onSave}
                disabled={isSaving}
                className={`inline-flex items-center gap-2 px-3.5 py-2 rounded-xl border text-xs sm:text-sm font-medium transition-all cursor-pointer ${
                  isSaved
              ...
              <button
                type="button"
                onClick={onShare}
                className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-700 dark:text-neutral-200 hover:bg-neutral-50 dark:hover:bg-neutral-750 text-xs sm:text-sm font-medium transition-all cursor-pointer"
              >
              ...
              <div className="relative">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-neutral-700 dark:text-neutral-200 hover:bg-neutral-50 dark:hover:bg-neutral-750 text-xs sm:text-sm font-medium transition-all cursor-pointer"
          ...
          {/* Bottom Compact Metadata Cards (Language, Duration, Views, Likes) */}
          <div className="mt-6 pt-5 border-t border-neutral-100 dark:border-neutral-800/80 grid grid-cols-2 sm:grid-cols-4 gap-3">
            <div className="flex items-center gap-3 p-2.5 rounded-2xl bg-neutral-50/80 dark:bg-neutral-800/50 border border-neutral-100 dark:border-neutral-800">
              ...
              <div className="min-w-0">
                <p className="text-[10px] text-neutral-400 dark:text-neutral-500 uppercase tracking-wider font-semibold">Language</p>
                <p className="text-xs font-bold text-neutral-800 dark:text-neutral-200 truncate">{formatLanguageName(video.language || language)}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-2.5 rounded-2xl bg-neutral-50/80 dark:bg-neutral-800/50 border border-neutral-100 dark:border-neutral-800">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs font-bold text-neutral-800 dark:text-neutral-200 truncate">{durationDisplay}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-2.5 rounded-2xl bg-neutral-50/80 dark:bg-neutral-800/50 border border-neutral-100 dark:border-neutral-800">
              ...
              <div className="min-w-0">
                <p className="text-[10px] text-neutral-400 dark:text-neutral-500 uppercase tracking-wider font-semibold">Views</p>
                <p className="text-xs font-bold text-neutral-800 dark:text-neutral-200 truncate">{viewsDisplay}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-2.5 rounded-2xl bg-neutral-50/80 dark:bg-neutral-800/50 border border-neutral-100 dark:border-neutral-800">
              ...
              <div className="min-w-0">
                <p className="text-[10px] text-neutral-400 dark:text-neutral-500 uppercase tracking-wider font-semibold">Likes</p>
                <p className="text-xs font-bold text-neutral-800 dark:text-neutral-200 truncate">{likesDisplay}</p>
              </div>
            </div>
          </div>
        </div>
